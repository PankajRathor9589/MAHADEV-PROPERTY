    ...
    <section className="section-shell">
      <div className="mx-auto max-w-lg rounded-[36px] border border-white/10 bg-slate-950/75 p-8 text-white shadow-panel backdrop-blur">
        ...
        <p className="mt-3 text-sm leading-7 text-white/65">
          Use your account to browse, save, or manage your property experience. Admin access is handled through the secure admin key page.
        </p>
        ...
        <p className="mt-6 text-sm text-white/65">
          ...
          <Link className="font-semibold text-gold-100 underline underline-offset-4" to="/admin/login">
            Use the admin key page
          </Link>
        </p>
